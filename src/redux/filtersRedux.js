...
// action creators
export const createActionAddSearchTag = payload => ({ payload,
  type: ADD_TAG });
export const createActionRemoveSearchTag = payload => ({ payload,
  type: REMOVE_TAG });
export const createActionChangeSearchDurationTo = payload => ({ payload,
  type: CHANGE_DURATION_TO });
export const createActionChangeSearchDurationFrom = payload => ({ payload,
